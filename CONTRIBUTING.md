# Contributing to GymSystems

We would love for you to contribute to GymSystems and help make it even better
...
Help us keep GymSystems open and inclusive. Please read and follow our [Code of Conduct][coc].
...
* Is this something we want? Sometimes people make feature requests that make sense for them, but aren't valuable
  to the rest of the users, or impede on other people's workflow. We try to always put the greater community
  first.
* Is the API valid? Does it change currently existing flags, or add new ones?
* What's the impact on the rest of the system? Does it affect other commands/flags?
...
We want to fix all the issues as soon as possible, but before fixing a bug we need to reproduce and confirm it. Please provide as much information about the issue as possible.
...
* Search [GitHub](https://github.com/OysteinAmundsen/gymsystems/pulls) for an open or closed PR
...
* Run the full test suite: `yarn test` (client unit tests, backend unit tests and full end-to-end protractor tests),
...
* In GitHub, send a pull request to `gymsystems:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the gymsystems test suites to ensure tests are still passing.
