 ...
 */
export function validateClub(obj: BelongsToClub, oldObj?: BelongsToClub, req?: Request): Promise<string> {
  return new Promise(async (resolve, reject) => {
    ...
    if (obj.club.id && me && !(me.role >= Role.Admin || obj.club.id === me.club.id)) {
      ...
      return resolve(`Club not found and you do not have the privileges to create it.`);
    }
